!(function (e, t) {
  ...
  var n = /*#__PURE__*/ (function () {
    ...
    o = /*#__PURE__*/ (function (e) {
      function s(i) {
        var n;
        return (
          ((n = e.call(this) || this).options = t({}, s.defaultOptions, i)),
          (n.container =
            "string" == typeof n.options.container
              ? document.querySelector(n.options.container)
              : n.options.container),
          (n.wrapper =
            "string" == typeof n.options.wrapper
              ? n.container.querySelector(n.options.wrapper)
              : n.options.wrapper || n.options.container),
          (n.item = []),
          n.refresh(!1),
      ...
      return (
        ...
        (n.addClones = function (e, t) {
          var i;
          void 0 === t && (t = 0);
          for (var s = [], n = 0; n < e; n++) {
            var o = this.item[(t + n) % this.item.length].cloneNode(!0);
            o.classList.add(this.options.cloneClassName), s.push(o);
          }
          (i = this.wrapper).append.apply(i, s);
        }),
        (n.removeClones = function (e) {
          void 0 === e && (e = 0),
            Array.from(
        ...
        (n.setClonesCount = function (e) {
          this.clonesCount !== e &&
            (this.clonesCount < e &&
              this.addClones(e - this.clonesCount, this.clonesCount),
        ...
        (n.getCalcData = function () {
          ...
          this.item.map(function (t) {
            var i = window.getComputedStyle(t),
              s =
                t.offsetWidth +
                parseInt(i.marginLeft) +
                parseInt(i.marginRight);
            e.itemWidth.push(s), (e.itemsWidth += s);
          });
          for (
            var t = e.itemWidth.length,
              i = this.options.clonesOverflow
                ? e.containerWidth
                : e.containerWidth - e.itemsWidth;
            i > e.clonesWidth ||
            e.clonesCount < this.options.clonesMin ||
            (this.options.clonesFinish && e.clonesCount % t > 0);
  ...
  var r = /*#__PURE__*/ (function (e) {
    ...
    return (
      (n.createFiller = function () {
        var e = this;
        (this.filler = new o(this.options)),
      ...
      (n.createTimeline = function () {
        ...
        return (
          ...
          this.tl.fromTo(
            ...
            {
              x: function () {
                return e.options.clonesOverflow
                  ? -e.filler.calcData.itemsWidth
                  : -(
                      e.filler.calcData.fullWidth -
                      e.filler.calcData.containerWidth
                    );
              },
            },
      ...
      (n.initPlugins = function () {
        this.plugin = {};
        for (
          var e = 0, t = Object.entries(this.options.plugins);
          e < t.length;
          e++
        ) {
          var i = t[e],
  ...
  var l = /*#__PURE__*/ (function () {
    function e(i, s) {
      (this.options = t({}, e.defaultOptions, s)),
        (this.reeller = i),
      ...
      (i.init = function () {
        ...
        (this.tickerFn = function () {
          var n = e.getScrollPos(),
            o = n - t;
          if (
            (e.options.bothDirection || (o = Math.abs(o)),
            e.options.reversed && (o *= -1),
            e.reeller.paused)
          )
            return (
              (i = Math.sign(o)),
              (t = n),
              s || (e.gsap.killTweensOf(e.tl), (s = !0)),
              void e.tl.timeScale(i * e.options.threshold)
            );
          if (o) {
            var r = o * e.options.multiplier,
              l =
                r > 0
                  ? Math.max(e.options.threshold, r)
                  : Math.min(-e.options.threshold, r);
            ...
            var a = e.options.stopOnEnd ? 0 : i * e.options.threshold;
