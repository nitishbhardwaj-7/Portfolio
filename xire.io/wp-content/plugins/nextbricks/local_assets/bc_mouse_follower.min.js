!(function (t, e) {
  ...
  return (function () {
    ...
    return (
        ...
        (this.event.mouseleave = function () {
          ...
          (this.event.mousemove = function (e) {
            t.gsap.to(t.pos, {
              ...
              onUpdate: function () {
                return (t.vel = {
                  x: e.clientX - t.pos.x == 0 ? 0.001 : e.clientX - t.pos.x,
                  y: e.clientY - t.pos.y == 0 ? 0.001 : e.clientY - t.pos.y,
                });
              },
            });
          }),
      ...
      (e.render = function (t) {
        if (!0 === t || (0 !== this.vel.y && 0 !== this.vel.x)) {
          if (
            ...
            var e =
                Math.min(
                  Math.sqrt(Math.pow(this.vel.x, 2) + Math.pow(this.vel.y, 2)) *
                    this.options.skewingDelta,
                  this.options.skewingDeltaMax
                ) * this.skewing,
              i = (180 * Math.atan2(this.vel.y, this.vel.x)) / Math.PI;
            this.setter.scaleX(1 + e), this.setter.scaleY(1 - e);
            var cursorStyles = window.getComputedStyle(this.el, "::before");
            if (cursorStyles.borderRadius == "50%") {
      ...
      (e.toggle = function (t) {
        !0 !== t && (!1 === t || this.visible) ? this.hide() : this.show();
      }),
