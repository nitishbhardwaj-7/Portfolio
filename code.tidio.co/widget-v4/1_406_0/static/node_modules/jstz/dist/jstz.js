  ...
  var jstz = (function () {
    ...
    var HEMISPHERE_SOUTH = "s",
      ...
      lookup_key = function lookup_key() {
        var january_offset = get_date_offset(
            new Date(consts.BASELINE_YEAR, 0, 2)
          ),
      ...
      get_from_internationalization_api =
        function get_from_internationalization_api() {
          var format, timezone;
          if (
          ...
          if (
            timezone &&
            (timezone.indexOf("/") > -1 || timezone === "UTC") &&
       ...
       * @returns {*}
       */
      best_dst_match = function best_dst_match(
        rule_list,
        preliminary_timezone
      ) {
