  ...
  _createClass(Frame, [
    ...
    },
    {
      ...
      value: function getMountTarget() {
        ...
        if (doc?.body?.children?.length === 0) {
          // getMountTarget should have at least one child injected by srcdoc prop
          // in some rendering contexts like wix, the usage of srcdoc is restricted
          // so we need to inject div manually and override body props and inject head tags
          if (this.props.noSrcDocBodyProps) {
          ...
          if (this.props.noSrcDocHeadTags) {
            doc.head.innerHTML = this.props.noSrcDocHeadTags;
          }
    ...
    },
    {
      ...
      value: function render() {
        ...
        delete props.noSrcDocBodyProps;
        delete props.noSrcDocHeadTags;
...
Frame.propTypes = {
  ...
  noSrcDocBodyProps: _propTypes2.default.object, // eslint-disable-line
  noSrcDocHeadTags: _propTypes2.default.string, // eslint-disable-line
};
Frame.defaultProps = {
  style: {},
  head: null,
  ...
  noSrcDocBodyProps: undefined,
  noSrcDocHeadTags: undefined,
};
