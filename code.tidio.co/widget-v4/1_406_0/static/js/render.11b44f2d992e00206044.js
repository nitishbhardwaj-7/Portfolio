!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = "8c954002-3d55-4d88-9097-ca3e2db22dca"),
      (e._sentryDebugIdIdentifier =
        "sentry-dbid-8c954002-3d55-4d88-9097-ca3e2db22dca"));
  } catch (e) {}
})(),
  (function () {
    var e =
    ...
    (e._sentryModuleMetadata = e._sentryModuleMetadata || {}),
      (function () {
        var t,
          o = new e.Error().stack,
          n = e._sentryModuleMetadata[o] || {},
          i = { "_sentryBundlerPluginAppKey:tidio-sentry-widget-app-key": !0 },
          d = {};
        for (t in n) n.hasOwnProperty(t) && (d[t] = n[t]);
        for (t in i) i.hasOwnProperty(t) && (d[t] = i[t]);
        e._sentryModuleMetadata[o] = d;
      })();
  })();
var _global =
  "undefined" != typeof window
    ...
    (o.d = function (e, t) {
      ...
      (function () {
        ...
        const t =
          ...
          n = t
            ? "https://code.tidio.co/widget-v4//dist/"
            : "https://code.tidio.co/widget-v4/";
        function i(e, t) {
          try {
        ...
        function a(e) {
          ...
          })(e, `${n.replace(/\/$/, "")}/1_406_0/static/js/widget.${o.h()}.js`);
        }
        const s = o(1912).A;
        (window.tidioChatApi = new s()),
          d(() =>
            setTimeout(() => {
              var d = window.document.getElementById("tidio-chat-code"),
              ...
              })("tidio-chat-code", window.document, (d) => {
                var s;
                t &&
                  window.__REDUX_DEVTOOLS_EXTENSION__ &&
                  ((d.contentWindow.__REDUX_DEVTOOLS_EXTENSION__ =
                    window.__REDUX_DEVTOOLS_EXTENSION__),
                  (d.contentWindow.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ =
                    window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__)),
                  (function (e) {
                    let t =
                      "https://code.tidio.co/widget-v4/static/js/WidgetIframe.js";
                    t = `${n}1_406_0/static/js/chunk-WidgetIframe-${o.h()}.js`;
                  ...
                  i(
                    d.contentWindow.document,
                    "https://code.tidio.co/widget-v4/fonts/mulish_SGhgqk3wotYKNnBQ.woff2"
                  ),
                  i(
                    window.document,
                    "https://code.tidio.co/widget-v4/fonts/inter_UcCo3FwrK3iLTcviYwYZ8UA3.woff2"
                  ),
                  (s = d.contentWindow.document),
                  ...
                  (d.contentWindow.tidioChatApi = window.tidioChatApi),
                  (d.contentWindow.FIRST_POSSIBLE_JS_EXECUTION = e),
