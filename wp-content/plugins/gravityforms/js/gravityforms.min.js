      ...
      ? (r[i].splice(o, 1),
        ...
        0 === (o = r[i].length)
          ? (jQuery("#" + t.gf_vars.message_id).html(""),
            gfMultiFileUploader.toggleDisabled(t, !1))
          : (jQuery("#error_" + a).remove(),
            o < t.gf_vars.max_files &&
              gfMultiFileUploader.toggleDisabled(t, !1)))
      : (r[i] = null),
    jQuery("#gform_uploaded_files_" + e).val(jQuery.toJSON(r)));
}
...
function gformDeleteListItem(e, t) {
  ...
  e.prop("disabled") ||
    (e.prop("disabled", !0),
    (r = (e = e.parents(".gfield_list_group")).parents(
...
var GFMergeTag = function () {
    (GFMergeTag.getMergeTagValue = function (e, t, r) {
      var i,
        n = gform.mergeTags.getMergeTagInfo(e, t, r);
      return n.isVisible
        ? ((i = jQuery(n.input)),
          !1 !==
          (i = window.gform.applyFilters(
            "gform_value_merge_tag_" + e + "_" + n.fieldId,
            !1,
            i,
            n.modifier
          ))
            ? i
            : gform.mergeTags.getFieldValue(e, t, r, n))
        : "";
    }),
    ...
    function (formId, formulaFields) {
      (this.formId = formId),
        ...
        (this.bindCalcEvents = function (e, t) {
          ...
          for (r in ((a.isCalculating[l] = !1), s))
            s.hasOwnProperty(r) &&
              ((i = s[r][1]),
              (n = parseInt(i, 10)),
              "checkbox" ==
                ...
                ? (jQuery(n).click(function () {
                  ...
                  0 <
                    (o = n.closest(".gfield--type-image_choice .gchoice"))
                      .length &&
...
(gform.recaptcha = {
    ...
    jQuery(".ginput_recaptcha:not(.gform-initialized)").each(function () {
      let e = jQuery(this),
        t = {
          ...
          "error-callback": () => {
            console.error(
              "Gravity Forms: There was an error initializing reCAPTCHA v2. Please ensure your reCAPTCHA API keys are valid."
            ),
              e.attr("data-recaptcha-error", "1");
          },
        };
  ...
  executeRecaptcha: async function (e, i) {
    ...
    if ("1" !== t.getAttribute("data-recaptcha-error"))
      return (
    ...
    function i(o) {
      ...
      (d = t.settings.multipart_params.form_id),
        ...
        t.bind("UploadProgress", function (e, t) {
          var r = t.percent + "%";
          m("#" + t.id + " span.gfield_fileupload_percent").html(r),
        ...
        t.bind("Error", function (e, t) {
          ...
          t.code === plupload.FILE_EXTENSION_ERROR
            ...
            : ((i = (r = JSON.parse(t.response))?.error?.code || t.code),
              (r = r?.error?.message || t.message),
              (i =
                (t.file?.name ? t.file.name + " - " : "") +
                _.error +
                `: ${i}, ${_.message}: ` +
                r),
              f(e.settings.gf_vars.message_id, i)),
            m("#" + t.file.id).html(""),
            e.removeFile(t.file),
            e.refresh();
        }),
