...
(() => {
  ...
  function d(e, t) {
    ...
    o && "assertive" === t ? (o.textContent = e) : i && (i.textContent = e),
    ...
    null === e &&
      (function () {
        ...
        (e.id = "a11y-speak-intro-text"),
          ...
          (e.textContent = (0, a.__)("Notifications")),
          e.setAttribute(
            "style",
            "position:absolute;margin:-1px;padding:0;height:1px;width:1px;overflow:hidden;clip-path:inset(50%);border:0;word-wrap:normal !important;"
          ),
  ...
  o()(s), ((window.wp = window.wp || {}).a11y = t);
})();
